...
Runs on GPU and needs NO depth (trains on GT geometry) -> can run now on Leonardo's data_floors.
  ...
  python -m pipelines.train_distance_head --data data_floors --panos_root ../data/zind/full_dataset \
      --ckpt runs/hardneg/best.pt --out runs/dist --epochs 20 --bs 128 --unfreeze
  python -m pipelines.train_distance_head --data data_floors --panos_root ../data/zind/full_dataset --selftest
"""
