...
reuse the e2p door crop so tokens can later be embedded by the trained encoder.
  ...
  python -m pipelines.build_floor_dataset --home ../data/zind/full_dataset/0025 --floor floor_01
  python -m pipelines.build_floor_dataset --root ../data/zind/full_dataset --max 50 --with_crops
"""
