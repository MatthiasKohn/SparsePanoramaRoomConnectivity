...
train/val splits later).
  ...
  python -m pipelines.build_door_dataset --zind_root ../data/zind/sample_tour --out data_doorpairs
  # the full download (after running data/zind/download_data.py):
  python -m pipelines.build_door_dataset --zind_root <ZIND_DOWNLOAD_DIR> --out data_doorpairs
"""
