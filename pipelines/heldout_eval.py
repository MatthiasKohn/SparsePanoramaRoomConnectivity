...
Connectivity AP needs only panos + the trained encoder (NO depth) -- runnable now.
  ...
  python -m pipelines.heldout_eval --root <ZIND_ROOT> \
      --only runs/full_ft/val_homes.txt --ckpt best.pt --max 60
  python -m pipelines.heldout_eval --root ../data/zind/full_dataset --selftest --max 20
"""
...
from pipelines.connectivity_graph import eval_home
