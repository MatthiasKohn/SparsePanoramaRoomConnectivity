...
Single home:   python -m pipelines.connectivity_graph --home <HOME_DIR> --ckpt door_encoder.pt
Many homes:    python -m pipelines.connectivity_graph --root <ZIND_ROOT> --ckpt door_encoder.pt --max 30
               (reports per-home AP and the MEAN AP -- use HELD-OUT homes for the real number)
Self-test:     python -m pipelines.connectivity_graph --home <HOME_DIR> --selftest
"""
...
def main():
    ...
    ap.add_argument("--ckpt", default="weights/door_encoder.pt")
