...
Front-end (per floor):
  ...
  per edge   : door-anchored MEASURED relative pose (sparsepano/pose/door_pose) + which-side
  ...
  solve      : SE(2) pose graph (sparsepano/pose/posegraph), compare recovered layout to GT.

  python -m pipelines.floor_graph_real                       # geometry + free-space
  python -m pipelines.floor_graph_real --ckpt best.pt        # + embedding prior (GPU)
  python -m pipelines.floor_graph_real --embed selftest      # exercise embed plumbing (CPU)
"""
