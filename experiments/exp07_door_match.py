...
Real run (laptop GPU):  python experiments/exp07_door_match.py            # kitchen<->floor
Self-test (no models):  python experiments/exp07_door_match.py --selftest
"""
...
from src.matching import DoorMatcher, door_crop
