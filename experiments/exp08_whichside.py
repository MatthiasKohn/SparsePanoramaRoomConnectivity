...
Because ZInD has GT pose, we can MEASURE whether appearance picks the right side.
    ...
    python experiments/exp08_whichside.py
    python experiments/exp08_whichside.py --selftest # no model, checks plumbing
"""
...
import config
from src import geom, providers, zind, door_pose, panoproj, pose as posemod
from src.matching import DoorMatcher
