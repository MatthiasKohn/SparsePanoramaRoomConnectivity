...
Validates the BACK-END on ZInD GT:
  ...
  at a random index and both are noised. The SE(2) pose graph (src/posegraph) must
...
need an appearance prior -> what the door embedding (exp16) provides.
  ...
  python experiments/exp17_floor_graph.py --home 0025 --floor floor_01
  python experiments/exp17_floor_graph.py --home 0009 --p_app 0.85
"""
...
import config
from src import zind, posegraph as pg
