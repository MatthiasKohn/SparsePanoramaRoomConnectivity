...
crop pair with its cosine -- you decide if it's really the same doorway.
  ...
  python experiments/exp13_immersight_match.py --ckpt runs/full/best.pt
  python experiments/exp13_immersight_match.py --ckpt door_encoder.pt --stems 1273530,1273546,1308360,1273537
  python experiments/exp13_immersight_match.py --selftest        # plumbing, no models
"""
...
import config
from src import panoproj, contrastive
