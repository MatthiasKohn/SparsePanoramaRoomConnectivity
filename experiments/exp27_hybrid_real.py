...
Edge sources into src.posegraph:
  - door edge  : door-anchored MEASURED pose (src/door_pose) + which-side flip candidate,
  ...
  python experiments/exp27_hybrid_real.py --colmap_frac 0.3            # sample tour, emulated
  python experiments/exp27_hybrid_real.py --home ../data/zind/full_dataset/0330 \
...
import config
from src import providers, door_pose, posegraph as pg
...
def main(a):
    ...
    if a.model:
        from experiments.exp24_colmap_compare import load_colmap
    ...
    import cv2
    from experiments.exp18_floor_graph_real import load_pano, side_pref_embedding, FOV
...
def _colmap_scale(colmap, prov):
    ...
    from experiments.exp24_colmap_compare import umeyama_2d, pos2d
