...
E1 used the GT pose. Here we use the door-anchored MEASURED pose (src/door_pose) and show
...
(should be low for the correct side, high for the flip).
  ...
  python experiments/exp21_gs_pair_estimated.py --a <stemA> --b <stemB>
"""
...
import config
from src import providers, geom, door_pose, gsplat_init as gsi
