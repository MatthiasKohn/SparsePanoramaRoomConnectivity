...
can see where the crop sits and whether it is really on a matching doorway.
  ...
  python legacy/experiments/exp15_match_saliency.py --data data_doorpairs --idx 7 --ckpt door_encoder.pt
  python legacy/experiments/exp15_match_saliency.py --pair cropA.png cropB.png --ckpt door_encoder.pt
  python legacy/experiments/exp15_match_saliency.py --data data_doorpairs --idx 3 --selftest
"""
