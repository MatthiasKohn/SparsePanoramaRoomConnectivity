...
reports mean room-position error vs GT.
  ...
  python legacy/experiments/exp22_gs_floor.py                                   # sample tour, GT poses
  python legacy/experiments/exp22_gs_floor.py --poses graph                     # estimated poses
  python legacy/experiments/exp22_gs_floor.py --home 0025 --depth_dir .../depth_meters --poses graph
"""
...
def get_provider(a):
    if a.home:
        from pipelines.floor_graph_real import make_provider
