...
Real run (laptop GPU):  python legacy/experiments/exp06_semantic_doors.py
Self-test (no model):   python legacy/experiments/exp06_semantic_doors.py --selftest
"""
...
from sparsepano.doors.doors import Door, fuse
