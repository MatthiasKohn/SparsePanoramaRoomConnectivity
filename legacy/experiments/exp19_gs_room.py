...
The differentiable GS optimization (CUDA rasterizer) is isolated in `optimize_room_gs`.
  ...
  python legacy/experiments/exp19_gs_room.py                       # sample tour, first pano
  python legacy/experiments/exp19_gs_room.py --stem <pano_stem>
  python legacy/experiments/exp19_gs_room.py --home 0025 --depth_dir .../depth_meters --stem <stem>
"""
